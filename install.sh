...
" 2>/dev/null || echo "?")
  ...
  CLAUDEKIT_AGENTS="architect reviewer tester deployer explorer security-auditor debug-detective doc-writer performance-analyst release-manager data-engineer ml-engineer devops-engineer cost-analyst spec-reader template-improver"
